<!-- Vendored from AminBlg/SimpleEnglish (MIT). See NOTICE.md for license. -->
...
| 4.2 | Do not omit words or use contractions to shorten sentences. Write out articles and "that". |
