...
Follow `skills/ux/references/sveltekit-setup-guide.md` for the complete setup procedure.
...
Follow `skills/ux/references/feature-slice-pattern.md` for the full specification.
...
Create a `README.md` for each feature following the template in `skills/ux/references/feature-slice-pattern.md`.
...
Follow the theming approach in `skills/ux/references/sveltekit-setup-guide.md`.
...
Follow `skills/ux/references/feature-slice-pattern.md` for layout lib conventions.
...
2. **Write view-model factory** in `src/libs/factories/{feature}.ts` following `skills/ux/references/factory-patterns.md`
...
See `skills/ux/references/prototype-quality.md` for detailed guidance on each checklist item.
