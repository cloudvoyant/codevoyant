...
Use the template from `skills/ux/references/html-template.md` as the base.
...
- See `skills/ux/references/html-template.md` for slideshow-specific markup patterns
