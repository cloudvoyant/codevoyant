...
- **`light`** — fast and low-cost. For mechanical and validation agents: executors, researchers, gates.
- **`standard`** — default reasoning. For most analysis agents: researchers, reviewers, update agents.
- **`heavy`** — deepest reasoning. For planning and design agents: skill planners and skill updaters.
...
- In agent files using the header format: a `**Model tier:** light` line instead of `**Model:** <id>`.
