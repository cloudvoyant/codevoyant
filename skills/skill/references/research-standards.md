...
Quality standards for research artifacts produced by skill:explore and related skill-workflow agents. Reference this file from agent instructions with: `Each finding must follow the format in 'skills/skill/references/research-standards.md'.`
