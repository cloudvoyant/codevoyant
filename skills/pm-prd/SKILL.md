---
description: 'Write a single Product Requirements Document (PRD) for a feature or capability. Consumes pm:explore research artifacts if available. Triggers on: "pm prd", "write a PRD", "create PRD", "draft PRD", "product requirements".'
name: pm:prd
license: MIT
...
argument-hint: '[feature-slug|linear-url] [--bg] [--silent]'
