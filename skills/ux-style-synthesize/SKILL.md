---
description: "Use when synthesizing the visual style of a website or app. Triggers on: \"ux style synthesize\", \"style synthesize\", \"extract style\", \"capture style\", \"analyze design\", \"synthesize design\", \"style reference\", \"design reference\". Visits a URL, screenshots at mobile/tablet/desktop breakpoints, and produces a style report + CSS theme."
name: ux:style-synthesize
license: MIT
