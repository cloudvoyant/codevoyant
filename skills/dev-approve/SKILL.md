---
description: 'Promote a draft architecture plan from .codevoyant/plans/ to docs/architecture/. Optionally creates Linear tasks from the plan task breakdown. Triggers on: "dev approve", "approve architecture", "promote arch doc", "publish design doc", "approve dev plan".'
name: dev:approve
license: MIT
...
argument-hint: '[plan-slug] [--push [linear-project-url]] [--silent]'
