...
These principles govern every explore run. Research agents and proposal writers must both conform.
...
```yaml
Agent:
  subagent_type: explore:researcher
...
```yaml
Agent:
  subagent_type: explore:proposal-writer
  run_in_background: true
