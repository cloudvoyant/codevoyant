...
- **`light`** — fast and low-cost. For mechanical and validation agents: reviewers, extractors, summarizers.
- **`standard`** — default reasoning. For most analysis agents: researchers, proposal writers.
