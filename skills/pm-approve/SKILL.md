---
description: 'Promote a draft roadmap or PRD from .codevoyant/ to docs/. Optionally syncs to Linear. Triggers on: "pm approve", "approve roadmap", "approve prd", "commit roadmap", "publish roadmap", "promote draft".'
name: pm:approve
license: MIT
...
argument-hint: '[slug] [--push [initiative-url]] [--silent]'
