---
name: compgeo
description: "Computational geometry — meshes, voxels, point clouds, and signed distance fields. Load when working with 3D formats (STEP, OBJ, STL, glTF), spatial analysis (BVH, raycasting, bounding volumes), or frontend 3D visualization (three.js, react-drei, threlte)."
license: MIT
