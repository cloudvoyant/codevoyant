...
- Optional `--branch` flag: `/spec:new my-plan-name --branch feature-branch`
  - Flag can be anywhere in the argument string
  - Branch name: alphanumeric, hyphens, underscores, slashes only
  - Invalid branch name → show error and stop
