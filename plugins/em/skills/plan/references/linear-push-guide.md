...
Tool: `mcp__claude_ai_Linear__save_initiative`
...
Tool: `mcp__claude_ai_Linear__create_attachment`
...
Alternative: `mcp__claude_ai_Linear__create_document` to create a Linear doc with content.
