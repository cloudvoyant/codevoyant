---
description: "Use when marking a spec plan as complete and archiving it. Triggers on: \"done\", \"complete plan\", \"finish plan\", \"mark complete\", \"wrap up plan\", \"spec done\". Optionally commits changes. Proactively suggest when all plan tasks appear finished."
