---
description: "Use when permanently removing a spec plan and all its files. Triggers on: \"delete plan\", \"remove plan\", \"destroy plan\", \"get rid of plan\", \"clean up plan\", \"spec delete\". Proactively suggest when a user calls a plan obsolete or a mistake."
