---
description: "Use when stopping a background agent or pausing a plan to capture session insights. Triggers on: \"stop plan\", \"halt execution\", \"stop background agent\", \"pause plan\", \"save progress\", \"take a break\", \"cancel execution\", \"spec stop\". Proactively suggest when user is switching tasks or ending a session."
